...
class _$_TokenData implements _TokenData {
  const _$_TokenData({this.token, this.refreshToken});
  ...
  @override
  String toString() {
    return 'TokenData(token: $token, refreshToken: $refreshToken)';
  }
...
abstract class _TokenData implements TokenData {
  const factory _TokenData({final String? token, final String? refreshToken}) =
      _$_TokenData;
