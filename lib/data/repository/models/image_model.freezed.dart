...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? imageLink, int? type});
}
...
class _$_ImageModel implements _ImageModel {
  const _$_ImageModel({this.imageLink, this.type});
  ...
  @override
  String toString() {
    return 'ImageModel(imageLink: $imageLink, type: $type)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, imageLink, type);
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel({final String? imageLink, final int? type}) =
      _$_ImageModel;
